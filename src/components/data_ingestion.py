...
class DataIngestion:
    ...
    def export_data_into_feature_store_file_path(self)->pd.DataFrame:
        ...
        try:
            ...
            creditcard_data = self.export_collection_as_dataframe(
            ...
            feature_store_file_path = os.path.join(raw_file_path,'credit_card_fraud.csv')
            creditcard_data.to_csv(feature_store_file_path,index=False)
